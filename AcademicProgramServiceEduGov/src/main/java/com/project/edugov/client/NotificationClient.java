...
public interface NotificationClient {
	...
	void sendNotification(@RequestParam("userId") Long userId, @RequestParam("entityId") Long entityId,
			@RequestParam("message") String message, @RequestParam("category") String category,
