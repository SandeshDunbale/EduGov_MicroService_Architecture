...
//    );
	...
	public static final List<String> openApiEndpoints = List.of("/api/auth/login", "/api/users/recoverEmail", // <--
																												// FIXED
																												// PATH
			"/api/auth/resetPassword", "/eureka", "/students/register", // <- MUST BE HERE
			"/faculty/register", "/api/identity/register", "/documents/student/upload", "/documents/faculty/upload",

			"/api/resources/by-type", "/api/infrastructure/by-type",
